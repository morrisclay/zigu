...
extern const struct _mp_obj_module_t mp_module_ukernel;
#undef MODULE_DEF_UKERNEL
#define MODULE_DEF_UKERNEL { MP_ROM_QSTR(MP_QSTR_ukernel), MP_ROM_PTR(&mp_module_ukernel) },
